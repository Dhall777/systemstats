defmodule Systemstats.Mem.Meminfo.Generator do
  ...
  def clean_insert_memory_data() do
    ...
    create_mem_e_int = String.slice(mem_e_clean, 6..13) |> String.to_integer()
    ...
    # create_mem_h_atom = String.slice(mem_h_clean, 0..9) |> String.to_atom()
    # create_mem_h_int = String.slice(mem_h_clean, 10..14) |> String.to_integer()
